...
export const metadata = createMetadata({
  title: "定制珠宝",
  description: "Noirven 诺梵定制珠宝：从意向到确认，提供材质、尺寸、预算与交付时间的清晰流程与常见问答。",
  path: "/custom",
});
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "适合纪念礼物、婚礼/纪念日、个人符号化设计、或希望在材质与尺寸上做专属调整的需求。我们强调克制的轻奢艺术语言，并保持信息透明与可确认。",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "通常包含：意向沟通（用途/风格/预算/时间）→ 方案确认（材质、主石与细节）→ 付款与制作 → 交付与归档。具体环节会随复杂度调整。",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "周期取决于款式复杂度与工艺（如珐琅、隐秘式镶嵌等）以及材料供给情况。沟通确认后，我们会给出可执行的时间预期，并在制作过程中同步关键节点。",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "可根据故事语言与预算选择金、铂金、玫瑰金、黑铑处理等金属，以及常见彩宝与钻石组合。我们会优先建议与作品气质一致、且在佩戴场景上可长期保持的组合。",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "七日归属用于呈现已编号的独一作品；定制服务则用于在明确需求下建立专属方案。两者都强调可追溯、可确认与一对一的作品叙事。",
        },
      },
    ],
  } as const;
    ...
    <div className="min-h-screen bg-[var(--porcelain)]">
      ...
      <main className="section-shell py-16">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-[var(--graphite)]">
          这是一个用于“把需求说清楚”的页面：用途、风格、预算、时间、尺寸与材质偏好。确认之后，再进入可执行的制作计划。
        </p>

        <section className="mt-12 grid gap-6 lg:grid-cols-3">
          <div className="border border-black/10 bg-white/50 p-6">
            <h2 className="text-lg">1) 意向沟通</h2>
            <p className="mt-3 text-sm leading-7 text-[var(--graphite)]">告诉我们：佩戴场景、喜欢的系列气质、预算区间与期望时间。</p>
          </div>
          <div className="border border-black/10 bg-white/50 p-6">
            <h2 className="text-lg">2) 方案确认</h2>
            <p className="mt-3 text-sm leading-7 text-[var(--graphite)]">明确：金属、主石与点睛宝石、比例与尺寸、以及关键工艺选择。</p>
          </div>
          <div className="border border-black/10 bg-white/50 p-6">
            <h2 className="text-lg">3) 制作与交付</h2>
            <p className="mt-3 text-sm leading-7 text-[var(--graphite)]">根据复杂度制定节点计划，制作期间同步关键进度，完成后安排交付与归档。</p>
          </div>
        </section>
